  ...
  render(props) {
    return (
      <div className="aboutOrContactPage">
        <h1> About </h1>
        <h3> Poetry in the United States is significantly more regionalized
      ...
      school English course.
        ...
        <h3> Conversely, the digital space offers more easily accessible
      ...
      or articles because those are the preferred medium for many people.
        ...
        <h3> poetry.seen was created to digitally visualize the
